...
public class TicketMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1368, 758));
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "From", "Cape Town", "Durban", "Kimberly", "Bloemfontein", "East London", "George", "Johannesburg", "Mthatha", "Nelspruit", "Polokwane", "Port Elizabeth", "Richards Bay", "Upington" }));

        jComboBox3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "To", "Cape Town", "Durban", "Kimberly", "Bloemfontein", "East London", "George", "Johannesburg", "Mthatha", "Nelspruit", "Polokwane", "Port Elizabeth", "Richards Bay", "Upington" }));

        jComboBox4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Class", "Personal", "Business" }));
        ...
        jButton3.setText("Find Flights");

        jButton4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jButton4.setText("Number of Tickets");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicketMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
